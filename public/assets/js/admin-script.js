...
class AdminPanel {
    ...
    async loadCategoryList() {
        try {
            ...
            if (result.success) {
                ...
                Swal.fire({
                    title: 'Hata!',
                    text: result.message || 'Kategoriler yüklenemedi',
                    icon: 'error'
                });
            }
        } catch (error) {
            ...
            Swal.fire({
                title: 'Hata!',
                text: 'Kategoriler yüklenirken hata oluştu: ' + error.message,
                icon: 'error'
            });
        }
    }
    ...
    renderCategorySelector(containerSelector) {
        console.log('renderCategorySelector called with:', containerSelector);
        console.log('Categories to render:', this.categories);
        ...
        if (!this.categories || this.categories.length === 0) {
            ...
            container.html('<p class="text-muted">Kategori bulunamadı</p>');
            return;
        }
        ...
        console.log('Categories rendered, adding click events...');
